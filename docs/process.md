...
![STEEPLE scan board](../assets/steeple-board.png)
...
|---|---|
| ![Futures wheel — the rise of digital banking](../assets/futures-wheel-digital-banking.png) | ![Futures wheel — pure decentralized finance](../assets/futures-wheel-defi.png) |

The final wheel maps first-, second-, and third-order consequences across technology, ethics, environment, and governance:

![Futures wheel — agentic AI becomes the default representative in embedded finance](../assets/futures-wheel-agentic-ai.png)
...
![Scenario template](../assets/scenario-template.png)
